...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (smart-mode-line git-gutter org-bullets yaml-mode solarized-theme magit helm-projectile projectile helm web-mode ensime use-package monokai-theme base16-theme evil-visual-mark-mode))))
(custom-set-faces
