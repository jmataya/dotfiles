...
(custom-set-variables
 ...
 '(package-selected-packages
   '(vterm terraform-mode clojure-mode treeview ox-gfm writeroom-mode markdown-mode+ ztree treemacs prettier-js vala-mode yaml-mode web-mode vue-mode use-package toc-org spaceline solarized-theme scss-mode rjsx-mode rainbow-delimiters paredit org-bullets neotree markdown-mode magit key-chord helm-projectile helm-ag gotest ggtags exec-path-from-shell evil-leader evil-commentary dracula-theme dockerfile-mode diminish counsel-projectile clojure-mode-extra-font-locking cider base16-theme all-the-icons)))
(custom-set-faces
